...
if($_SESSION['UserID'] == "")
	...
	if($_SESSION['Status'] != "PM")
	{
		echo "This page for Pm Staff only!";
		exit();
	}	
...
<div id="navbar">
  ...
  <ul id="MenuBar1" class="MenuBarHorizontal">
      <li><a href="page_pm.php" title="Home"> HOME</a>
...
<li><a href="myapproved_pm.php?permit_sheet_pm_staff_name=<?php echo $objResult["Name"];?>" title="MyWorkpermit">MyApproved</a></li>
