...
function myFunction() {
    window.print();
	window.location.href = 'report_workpermit.php?permit_sheet_no_id=<?php echo $row_Recordset1['permit_sheet_no_id']; ?>';
}
...
<form id="form1" name="form1" method="post" action="">
  <table width="976" height="1400" border="0" align="center">
    ...
    <tr>
      ...
      <td height="25" colspan="13" >ในพื้นที่ (Area of): <u><font color="#0000FF"> <?php echo $row_Recordset1['permit_sheet_area_of']; ?> </font></u></td>
    </tr>
    <tr>
