...
<div id="header">
 ...
 <form action="check_login.php" method="POST" style="position:absolute;top:20px;right:5px; ">
  ...
  <tr>
    ...
    <td width="198" bgcolor="#FFFFFF"><input name="txtUsername" type="text" id="txtUsername" /></td>
  </tr>
  <tr>
    <td height="20" bgcolor="#FFFFFF" ><strong>Password:</strong></td>
    <td bgcolor="#FFFFFF"><input name="txtPassword" type="password" id="txtPassword" /></td>
  </tr>
  <tr>
...
<div id="navbar">
  <div id="navbarIn"><center><strong><p><h4 style="color:#FFF"> Welcome To Work Permit System.</h2></p>
    </strong>  
  </center></div>
</div>

<div id="main">
  <div id="mainin"> <center> <?php include("all_system/work_today.php"); ?>  </center> </div></div>
