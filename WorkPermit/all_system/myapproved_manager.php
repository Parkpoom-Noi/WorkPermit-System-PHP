...
if (isset($_GET['permit_sheet_manager_approved__name'])) {
  $colname_Recordset1 = $_GET['permit_sheet_manager_approved__name'];
}
mysql_select_db($database_workpermit, $workpermit);
$query_Recordset1 = sprintf("SELECT * FROM permit_sheet WHERE permit_sheet_manager_approved__name = %s", GetSQLValueString($colname_Recordset1, "text"));
...
<table width="1022" height="89" border="0"   align="center"  class="table table-hover"  style="width: auto; height:auto;">
  <tr bgcolor="#A0A0A4" border="50" bordercolor="#000000">
    <th width="100" height="39" scope="col">Permit No.</center></th>
