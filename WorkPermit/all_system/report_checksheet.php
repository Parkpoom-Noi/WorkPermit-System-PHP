...
<form method="POST" name="form1"  ><table width="1016" height="1178" border="1" cellpadding="5" cellspacing="0" align="center">
  <tr>
...
inspection by risk </td>
  ...
  <tr>
    ...
    <table width="1021" height="197" border="1" cellpadding="5" cellspacing="0" >
        <tr>
          <th width="778" height="37" scope="col" align="left">&nbsp;&nbsp; &nbsp;&nbsp; <u><strong> ผู้รับเหมา (Contractor chief) </strong></u></th>
          <th width="237" bgcolor="#808080" scope="col"><center>Inspector</center></th>
        </tr>
        <tr>
        ...
        <tr>
          <td> <center> <input type="submit" name="button" id="button" value="Print Report Workpermit" onclick="MM_goToURL('parent','print_report_checksheet.php?permit_sheet_no_id=<?php echo $row_Recordset1['permit_sheet_no_id']; ?>');return document.MM_returnValue" />  </center></td>
        </tr>
      </table></td>
  </tr>
  </table>
