...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE permit_sheet SET permit_sheet_ordinal=%s, permit_sheet_issued_date=%s, permit_sheet_expined_date=%s, permit_sheet_incharge_email=%s, permit_sheet_area_owner_name=%s, permit_sheet_area_owner_status=%s, permit_sheet_area_owner_dept=%s, permit_sheet_area_owner_section=%s, permit_sheet_area_owner_email=%s, permit_sheet_pm_staff_name=%s, permit_sheet_pm_staff_dept=%s, permit_sheet_pm_staff_section=%s, permit_sheet_pm_staff_email=%s, permit_sheet_pm_staff_sig=%s, permit_sheet_pm_staff_answer=%s, permit_sheet_manager_approved__name=%s, permit_sheet_manager_approved__dept=%s, permit_sheet_manager_approved_section=%s, permit_sheet_manager_approved_email=%s, permit_sheet_soh_div_name=%s, permit_sheet_soh_div_dept=%s, permit_sheet_soh_div_section=%s, permit_sheet_soh_div_email=%s WHERE permit_sheet_no_id=%s",
                       ...
                       GetSQLValueString($_POST['permit_sheet_pm_staff_answer'], "text"),
...
if( $_POST['permit_sheet_pm_staff_answer'] == 'accept' )
{
...
Request you to approve details in work permit. </b></u>   \n\n<b>Please login to approve or reject requirement on the following web pages.</b>\n\n<a href='http://localhost/WorkPermit/member_m&area/approved_area.php?permit_sheet_ordinal=".$_POST['permit_sheet_ordinal']."'>http://localhost/WorkPermit/member_m&area/approved_area.php?permit_sheet_ordinal=".$_POST['permit_sheet_ordinal']."</a>
					...
					$strHeader2 .= "From: ".$_POST['permit_sheet_pm_staff_name']." < ".$_POST['permit_sheet_pm_staff_email']. ">\r\nReply-To:  " .$_POST['permit_sheet_pm_staff_email']. " ";
					$strMessage2 = nl2br( "<h3>To : ".$_POST['permit_sheet_incharge_name']." (Incharge) </h3>
						\n 
						<u><b>
Your Work permit APM Staff Approved success . </b></u>   \n
						\n
						\n====================================================================================\n
						<b><u>E-mail Send from Work permit System. </b></u>
						\n====================================================================================" 
...
Request you to approve details in work permit. </b></u>   \n\n<b>Please login to approve or reject requirement on the following web pages.</b>\n\n<a href='http://localhost/WorkPermit/member_area/approved_area.php?permit_sheet_ordinal=".$_POST['permit_sheet_ordinal']."'>http://localhost/WorkPermit/member_area/approved_area.php?permit_sheet_ordinal=".$_POST['permit_sheet_ordinal']."</a>
					...
					$strTo2 =   $_POST['permit_sheet_incharge_email'] ;  
					$strSubject2 =  "Your Work permit PM Staff Approved success" ;
					$strHeader2 = "Content-type: text/html; charset=UTF-8\r\n"; 
					$strHeader2 .= "From: ".$_POST['permit_sheet_pm_staff_name']." < ".$_POST['permit_sheet_pm_staff_email']. ">\r\nReply-To:  " .$_POST['permit_sheet_pm_staff_email']. " ";
					$strMessage2 = nl2br( "<h3>To : ".$_POST['permit_sheet_incharge_name']." (Incharge) </h3>
						\n 
						<u><b>
Your Work permit PM Staff Approved success . </b></u>   \n
						\n
						\n====================================================================================\n
						<b><u>E-mail Send from Work permit System. </b></u>
						\n====================================================================================" 
...
<title>PM Staff Approved</title>


  <script src="https://code.jquery.com/jquery-1.10.2.js"></script>
         <script>
            $(document).ready(function() {
                $('input[name="permit_sheet_pm_staff_answer"]').click(function() 
                {
...
In case of cut off or connect the power supply or electricity system , contracotor should infrom to PM to take an action.</td>
    ...
    <tr>
      <td height="30" colspan="24" scope="row" bgcolor="#FFFF00"><strong>เจ้าหน้าที่แผนก PM</strong></td>
    ...
    <tr>
      ...
      <td colspan="22" rowspan="3"  align="center" bgcolor="#FFFF00" ><input type="radio" name="permit_sheet_pm_staff_answer" value="accept" />
Accept
  <input type="radio" name="permit_sheet_pm_staff_answer" value="decline" />
Decline
<div id="pm" style="display: none" > Please insert your comment.
  <input type="textbox" name="pmstaff" />
</div>
<br />
<input name="input" type="submit" value="Send submit" />
<input name="permit_sheet_pm_staff_sig" type="text" value="<?php echo $objResult["Username"];?>" readonly="readonly" style="display: none" /></td>
      <td width="28" height="30"bgcolor="#FFFF00"  ></td>
      </tr>
    <tr>
      <td scope="row" height="30" bgcolor="#FFFF00" ></td>
    ...
    <tr>
      ...
      <td colspan="22" rowspan="3" align="center" ><input name="permit_sheet_area_owner_status" type="text" value="<?php echo $row_Recordset1['permit_sheet_area_owner_status']; ?>"   size="14" maxlength="14" readonly="readonly"  style="display: none"  /></td>
      <td height="30" ></td>
      </tr>
    <tr>
      <td scope="row" height="30"></td>
