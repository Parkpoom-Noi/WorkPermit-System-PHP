...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE permit_sheet SET permit_sheet_ordinal=%s, permit_sheet_issued_date=%s, permit_sheet_expined_date=%s, permit_sheet_incharge_email=%s, permit_sheet_area_owner_name=%s, permit_sheet_area_owner_dept=%s, permit_sheet_area_owner_section=%s, permit_sheet_area_owner_email=%s, permit_sheet_pm_staff_name=%s, permit_sheet_pm_staff_dept=%s, permit_sheet_pm_staff_section=%s, permit_sheet_pm_staff_email=%s, permit_sheet_manager_approved__name=%s, permit_sheet_manager_approved__dept=%s, permit_sheet_manager_approved_section=%s, permit_sheet_manager_approved_email=%s, permit_sheet_soh_div_name=%s, permit_sheet_soh_div_dept=%s, permit_sheet_soh_div_section=%s, permit_sheet_soh_div_email=%s, permit_sheet_soh_div_sig=%s, permit_sheet_soh_div_answer=%s WHERE permit_sheet_no_id=%s",
                       ...
                       GetSQLValueString($_POST['permit_sheet_soh_div_answer'], "text"),
...
if( $_POST['permit_sheet_soh_div_answer'] == 'accept' )
	{
					ini_set("SMTP","170.95.36.198");

					$strTo =     $_POST['permit_sheet_incharge_email'] ; 
					$strSubject =  "Your Work permit is success." ;
					$strHeader = "Content-type: text/html; charset=UTF-8\r\n"; 
					$strHeader .= "From: ".$_POST['permit_sheet_soh_div_name']." < ".$_POST['permit_sheet_soh_div_email']. ">\r\nReply-To:  " .$_POST['permit_sheet_soh_div_email']."";
					$strMessage = nl2br( "<h3>To : ".$_POST['permit_sheet_incharge_name']." (Incharge) </h3>
						\n 
						<u><b>
Your Work permit is success. </b></u>   \n\n<b>Please login to see your work permit on the following web pages.</b>\n\n
...
<title>SOH Div. Approved</title>


  <script src="https://code.jquery.com/jquery-1.10.2.js"></script>
         <script>
				$(document).ready(function() {
				$('input[name="permit_sheet_soh_div_answer"]').click(function() 
                {
...
$(function(){
	...
	var startDateTextBox = $('#permit_sheet_issued_date');
	var endDateTextBox = $('#permit_sheet_expined_date');
	var now = new Date();
...
<form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
  <table width="" border="0" align="center" cellpadding="0" cellspacing="0"  >
    ...
    <tr>
      ...
      <td height="30" colspan="21" ><strong>เอกสารขออนุญาตเข้าปฏิบัติงานของผู้รับเหมาหรือบุคคลภายนอก (Permit to Work)</strong></td>
    ...
    <tr>
      <td colspan="24" scope="row"><div style="display: none"><label>
        ...
        เรียกดู เอกสารเพิ่มเติมประกอบเอกสารขออนุญาต <a href="additional_files.php?Filesordinal=<?php echo $row_Recordset1['permit_sheet_ordinal']; ?>">( Additional documents) </a></td>
    </tr>
    <tr>
...
In case of cut off or connect the power supply or electricity system , contracotor should infrom to PM to take an action.</td>
    ...
    <tr>
      <td height="30" colspan="24" scope="row"><strong>เจ้าของพื้นที่ปฏิบัติงาน (Area owner)</strong></td>
      <td colspan="6" rowspan="5" ><table width="209" height="154" border="1" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td  height="112" align="center" class="italic"  ><?php echo $row_Recordset1['permit_sheet_area_owner_sig']; ?></td>
        </tr>
      </table></td>
      </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="6" rowspan="5" ><table width="209" height="157" border="1" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td  height="115" align="center" class="italic" ><?php echo $row_Recordset1['permit_sheet_manager_approved__sig']; ?></td>
        </tr>
      </table></td>
      </tr>
    <tr>
    ...
    <tr>
      <td height="30" colspan="24" scope="row" bgcolor="#FFFF00" ><strong>เจ้าหน้าที่ฝ่ายรักษาความปลอดภัย (SOH Div.)</strong></td>
    ...
    <tr>
      <td height="30" colspan="24" scope="row" bgcolor="#FFFF00" ></td>
      </tr>
    <tr>
      <td height="30" colspan="24" scope="row" bgcolor="#FFFF00"  ></td>
      </tr>
    ...
    <tr>
      <td height="30" colspan="3" scope="row" bgcolor="#FFFF00"  >หมายเหตุ :</td>
      <td height="30" colspan="27" bgcolor="#FFFF00"  >กรณีตรวจพบว่าผู้รับเหมาไม่ปฏิบัติงานตามกฏความปลอดภัย หรือไม่ได้มีการเตรียมการป้องกันการเกิดอัคคีภัย อุบัติเหตุ </td>
      </tr>
    <tr>
      <td scope="row" height="30"bgcolor="#FFFF00" ></td>
      <td height="30" bgcolor="#FFFF00" ></td>
      <td height="30" bgcolor="#FFFF00" ></td>
      <td height="30" colspan="27" bgcolor="#FFFF00"  >หรืออันตรายที่อาจเกิดขึ้นจากการปฏิบัติงาน บริษัทฯ จะไม่อนุญาตให้ปฏิบัติงานดังกล่าวจนกว่าจะมีการแก้ไขให้ปลอดภัย</td>
      </tr>
    <tr>
      <td scope="row" height="30"bgcolor="#FFFF00" ></td>
      <td height="30" bgcolor="#FFFF00" ></td>
      <td height="30" bgcolor="#FFFF00" ></td>
      <td colspan="12" rowspan="2" bgcolor="#FFFF00"   ><table width="409" height="52" border="1" cellpadding="0" cellspacing="0">
        <tr>
      ...
      <td colspan="12" rowspan="2" bgcolor="#FFFF00"  ><table width="409" height="49" border="1" cellpadding="0" cellspacing="0">
        <tr>
          <td width="170" height="40" align="center" bgcolor="#A0A0A4"><p>วันที่ใบอนุญาตหมดอายุ<br />
            Expired date </p></td>
    ...
    <tr>
      <td scope="row" height="30"bgcolor="#FFFF00" ></td>
      <td height="30" colspan="26" rowspan="3" align="center" bgcolor="#FFFF00" ><input type="radio" name="permit_sheet_soh_div_answer" value="accept" />
        Accept
        <input type="radio" name="permit_sheet_soh_div_answer" value="decline" />
        Decline
        <div id="sohdiv" style="display: none" > Please insert your comment.
          <input type="textbox" name="sohdiv" />
          </div>
        <br />
        <input name="input4" type="submit" value="Send submit" />
        <input name="permit_sheet_soh_div_sig" type="text" value="<?php echo $objResult["Username"];?>" readonly="readonly"  style="display: none"  /></td>
      <td height="30" bgcolor="#FFFF00"  ></td>
      <td height="30"bgcolor="#FFFF00"  ></td>
      <td height="30" bgcolor="#FFFF00" ></td>
    </tr>
