...
if (isset($_GET['permit_sheet_soh_div_name'])) {
  $colname_Recordset1 = $_GET['permit_sheet_soh_div_name'];
}
mysql_select_db($database_workpermit, $workpermit);
$query_Recordset1 = sprintf("SELECT * FROM permit_sheet WHERE permit_sheet_soh_div_name = %s", GetSQLValueString($colname_Recordset1, "text"));
