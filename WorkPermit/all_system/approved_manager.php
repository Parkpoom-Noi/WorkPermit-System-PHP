...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE permit_sheet SET permit_sheet_ordinal=%s, permit_sheet_issued_date=%s, permit_sheet_expined_date=%s, permit_sheet_incharge_email=%s, permit_sheet_area_owner_name=%s, permit_sheet_area_owner_dept=%s, permit_sheet_area_owner_section=%s, permit_sheet_area_owner_email=%s, permit_sheet_pm_staff_name=%s, permit_sheet_pm_staff_dept=%s, permit_sheet_pm_staff_section=%s, permit_sheet_pm_staff_email=%s, permit_sheet_manager_approved__name=%s, permit_sheet_manager_approved__dept=%s, permit_sheet_manager_approved_section=%s, permit_sheet_manager_approved_email=%s, permit_sheet_manager_approved__sig=%s, permit_sheet_manager_approved_answer=%s, permit_sheet_soh_div_name=%s, permit_sheet_soh_div_dept=%s, permit_sheet_soh_div_section=%s, permit_sheet_soh_div_email=%s WHERE permit_sheet_no_id=%s",
                       ...
                       GetSQLValueString($_POST['permit_sheet_manager_approved_answer'], "text"),
...
if( $_POST['permit_sheet_manager_approved_answer'] == 'accept' )
	{
					...
					$strMessage = nl2br( "<h3>To : ".$_POST['permit_sheet_soh_div_name']." (SOH Div.) </h3>
						\n 
						<u><b>
Request you to approve details in work permit. </b></u>   \n\n<b>Please login to approve or reject requirement on the following web pages.</b>\n\n<a href='http://localhost/WorkPermit/member_admin/approved_admin.php?permit_sheet_ordinal=".$_POST['permit_sheet_ordinal']."'>http://localhost/WorkPermit/member_admin/approved_admin.php?permit_sheet_ordinal=".$_POST['permit_sheet_ordinal']."</a>
						\n
						\n====================================================================================\n
					...
					$strSubject2 =  "Your Work permit Manager Approved success" ;
					$strHeader2 = "Content-type: text/html; charset=UTF-8\r\n"; 
					$strHeader2 .= "From: ".$_POST['permit_sheet_manager_approved__name']." < ".$_POST['permit_sheet_manager_approved_email']. ">\r\nReply-To:  " .$_POST['permit_sheet_manager_approved_email']. " ";
					$strMessage2 = nl2br( "<h3>To : ".$_POST['permit_sheet_incharge_name']." (Incharge) </h3>
						\n 
						<u><b>
Your Work permit Manager  Approved success . </b></u>   \n
						\n
						\n====================================================================================\n
						<b><u>E-mail Send from Work permit System. </b></u>
						\n====================================================================================" 
...
<title>Manager Approved</title>
  ...
  <script>
				...
				$('input[name="permit_sheet_manager_approved_answer"]').click(function() 
                {
                   
                    $('#managerapproved').hide(); 
                    var value = $(this).val();
                    if (value == 'decline'){
                        $('#managerapproved').show();
                    }
                    else{
                        $('#'+value).show();
                    }
...
In case of cut off or connect the power supply or electricity system , contracotor should infrom to PM to take an action.</td>
    ...
    <tr>
      <td height="30" colspan="24" scope="row" bgcolor="#FFFF00"  ><strong>หัวหน้าแผนก (Manager Approved)</strong></td>
    ...
    <tr>
      ...
      <td colspan="22" rowspan="3" align="center"  bgcolor="#FFFF00"  ><input type="radio" name="permit_sheet_manager_approved_answer" value="accept" />
Accept
  <input type="radio" name="permit_sheet_manager_approved_answer" value="decline" />
Decline
<div id="managerapproved" style="display: none" > Please insert your comment.
  <input type="textbox" name="managerapproved" />
</div>
<br />
<input name="input3" type="submit" value="Send submit" />
<input name="permit_sheet_manager_approved__sig" type="text" value="<?php echo $objResult["Username"];?>" readonly="readonly"  style="display: none"  /></td>
