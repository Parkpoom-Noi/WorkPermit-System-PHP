...
if (isset($_GET['permit_sheet_area_owner_name'])) {
  $colname_Recordset1 = $_GET['permit_sheet_area_owner_name'];
}
mysql_select_db($database_workpermit, $workpermit);
$query_Recordset1 = sprintf("SELECT * FROM permit_sheet WHERE permit_sheet_area_owner_name = %s", GetSQLValueString($colname_Recordset1, "text"));
...
<a href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, 0, $queryString_Recordset1); ?>">First</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, max(0, $pageNum_Recordset1 - 1), $queryString_Recordset1); ?>">Previous</a>&nbsp;&nbsp;&nbsp;หน้าที่
  <?php
