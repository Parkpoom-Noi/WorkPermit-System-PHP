...
<div align="right">
  <label>
    Permit No. <input name="permit_sheet_no_id" type="text"   value="<?php echo $row_Recordset1['permit_sheet_no_id']; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  </label></div><br />
<table width="1016" height="1183" border="1" cellpadding="0" cellspacing="0" align="center">
  <tr>
  ...
  <tr>
    <td colspan="6" rowspan="3">
      <table width="100%" height="152" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="43%">ชื่อ (Name) :
            <input name="check_sheet_inspector_name" type="text" size="35" maxlength="60"   /></td>
          <td width="57%">นามสกุล (Surname) :
            <input name="check_sheet_inspector_surname" type="text" size="35" maxlength="60" /></td>
        </tr>
        <tr>
          <td colspan="2">บริษัท (Company) :
            <input name="check_sheet_inspector_company" type="text" size="60" maxlength="100"   /></td>
          </tr>
      </table>
      </td>
