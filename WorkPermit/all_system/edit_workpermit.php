...
else
	{
		ini_set("SMTP","170.95.36.198");
					...
					$strMessage = nl2br( "<h3>To : ".$_POST['permit_sheet_area_owner_name']." (Area owner) </h3>
						\n 
						<u><b>
Request you to approve details in work permit. </b></u>   \n\n<b>Please login to approve or reject requirement on the following web pages.</b>\n\n<a href='http://localhost/WorkPermit/approved_area.php?permit_sheet_ordinal=".$_POST['permit_sheet_ordinal']."'>http://localhost/WorkPermit/approved_area.php?permit_sheet_ordinal=".$_POST['permit_sheet_ordinal']."</a>
						\n
						\n====================================================================================\n
						<b><u>E-mail Send from Work permit System. </b></u>
						\n====================================================================================" 
...
<span class="selectRequiredMsg">*</span></span> </td>
  ...
  <tr>
    ...
    <td colspan="17" rowspan="3"><label>
      ...
      เรียกดู เอกสารเพิ่มเติมประกอบเอกสารขออนุญาต <a href="additional_files.php?Filesordinal=<?php echo $row_Recordset1['permit_sheet_ordinal']; ?>">( Additional documents) 
      </a></label><br />เพิ่มข้อมูลผู้รับเหมา  
      <a href="add_chief.php?permit_sheet_no_id=<?php echo $row_Recordset1['permit_sheet_no_id']; ?>">Add Contractor Chief</a>
      </td>
    </tr>
  <tr>
...
<table width="1022" height="36" align="center" >
   <tr>
     <th  width="160" height="30" bgcolor="#808080" scope="row">PM Staff</th>
     <td width="211" height="30" ><input name="permit_sheet_pm_staff_name" type="text" value="<?php echo $row_Recordset1['permit_sheet_pm_staff_name']; ?>" size="25" maxlength="50" readonly="readonly"  /></td>
     <td width="209" height="30" ><input name="permit_sheet_pm_staff_section" type="text" value="<?php echo $row_Recordset1['permit_sheet_pm_staff_section']; ?>" size="25" maxlength="50" readonly="readonly" /></td>
     <td width="209" height="30" ><input name="permit_sheet_pm_staff_dept" type="text" value="<?php echo $row_Recordset1['permit_sheet_pm_staff_dept']; ?>" size="25" maxlength="50" readonly="readonly" /></td>
     <td width="209" height="30" ><input name="permit_sheet_pm_staff_email" type="text" value="<?php echo $row_Recordset1['permit_sheet_pm_staff_email']; ?>" size="25" maxlength="50" readonly="readonly" /></td>
   </tr>
   </table>
  </div>
 <table width="1022" height="132" align="center">
   <tr>
     <th width="160" height="30" bgcolor="#808080" scope="row" >Area onwer </th>
     <td height="30" width="211" ><input name="permit_sheet_area_owner_name" type="text" value="<?php echo $row_Recordset1['permit_sheet_area_owner_name']; ?>" size="25" maxlength="50" readonly="readonly"  /></td>
     <td height="30" width="209" ><input name="permit_sheet_area_owner_section" type="text" value="<?php echo $row_Recordset1['permit_sheet_area_owner_section']; ?>" size="25" maxlength="50" readonly="readonly" /></td>
     <td height="30" width="209" ><input name="permit_sheet_area_owner_dept" type="text" value="<?php echo $row_Recordset1['permit_sheet_area_owner_dept']; ?>" size="25" maxlength="50" readonly="readonly" /></td>
     <td height="30" width="209" ><input name="permit_sheet_area_owner_email" type="text" value="<?php echo $row_Recordset1['permit_sheet_area_owner_email']; ?>" size="25" maxlength="50" readonly="readonly" /></td>
   </tr>
   <tr>
     <th width="160" height="30" bgcolor="#808080" scope="row">Approved </th>
   <td height="30" width="211" ><input name="permit_sheet_manager_approved__name" type="text" value="<?php echo $row_Recordset1['permit_sheet_manager_approved__name']; ?>" size="25" maxlength="50" readonly="readonly"  /></td>
   <td height="30" width="209" ><input name="permit_sheet_manager_approved_section" type="text" value="<?php echo $row_Recordset1['permit_sheet_manager_approved_section']; ?>" size="25" maxlength="50" readonly="readonly" /></td>
     <td height="30" width="209" ><input name="permit_sheet_manager_approved__dept" type="text" value="<?php echo $row_Recordset1['permit_sheet_manager_approved__dept']; ?>" size="25" maxlength="50" readonly="readonly" /></td>
     <td height="30" width="209" ><input name="permit_sheet_manager_approved_email" type="text" value="<?php echo $row_Recordset1['permit_sheet_manager_approved_email']; ?>" size="25" maxlength="50" readonly="readonly" /></td>
   </tr>
   <tr>
     <th height="30" bgcolor="#808080" scope="row" >SOH Div.</th>
     <td height="30" ><input name="permit_sheet_soh_div_name" type="text" value="<?php echo $row_Recordset1['permit_sheet_soh_div_name']; ?>" size="25" maxlength="50" readonly="readonly"/></td>
     <td height="30" ><input name="permit_sheet_soh_div_section" type="text" value="<?php echo $row_Recordset1['permit_sheet_soh_div_section']; ?>" size="25" maxlength="50" readonly="readonly" /></td>
     <td height="30" ><input name="permit_sheet_soh_div_dept" type="text" value="<?php echo $row_Recordset1['permit_sheet_soh_div_dept']; ?>" size="25" maxlength="50" readonly="readonly" /></td>
     <td height="30" ><input name="permit_sheet_soh_div_email" type="text" value="<?php echo $row_Recordset1['permit_sheet_soh_div_email']; ?>" size="25" maxlength="50" readonly="readonly" /></td>
   </tr>
   <tr>
     <th width="160" height="30" scope="row" ></th>
     <td height="30" width="211" ></td>
     <td height="30" width="209"  align="center"><input type="submit" value="Save Change" /></td>
     <td height="30" width="209" ></td>
     <td height="30" width="209" ></td>
   </tr>
 </table>
