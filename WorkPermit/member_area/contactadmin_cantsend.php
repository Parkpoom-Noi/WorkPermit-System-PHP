<?php 
	...
	if($_SESSION['Status'] != "AREA")
	{
		echo "This page for Area owner only!";
		exit();
	}	
...
<div id="navbar">
  ...
  <ul id="MenuBar1" class="MenuBarHorizontal">
      <li><a href="page_areaowner.php" title="Home"> HOME</a>
...
<li><a href="myapproved_area.php?permit_sheet_area_owner_name=<?php echo $objResult["Name"];?>" title="MyWorkpermit">MyApproved</a></li>
...
<div id="main">
  <div id="mainin"> <center>  <?php include("../all_system/contactadmin_cantsend.php"); ?> </center> </div></div>
